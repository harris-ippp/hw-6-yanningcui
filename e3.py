...
selected_county = election_df[election_df.index == "Accomack County"]
selected_county = selected_county.plot(x = "Year", y = "Republican%")
selected_county.get_figure().savefig("accomack.png")
